...
import com.shilo.ecommerce.ecom_mono.config.AppConstants;
import com.shilo.ecommerce.ecom_mono.dto.OrderDTO;
import com.shilo.ecommerce.ecom_mono.dto.OrderRequestDTO;
import com.shilo.ecommerce.ecom_mono.dto.OrderStatusUpdateDTO;
import com.shilo.ecommerce.ecom_mono.dto.StripePaymentDTO;
import com.shilo.ecommerce.ecom_mono.response.OrderResponse;
import com.shilo.ecommerce.ecom_mono.service.OrderService;
...
//    }
    ...
    public ResponseEntity<OrderDTO> updateOrderStatusSeller(@PathVariable Integer orderId,
                                                            @RequestBody OrderStatusUpdateDTO orderStatusUpdateDto) {
        OrderDTO order = orderService.updateOrder(orderId, orderStatusUpdateDto.getStatus());
        return new ResponseEntity<OrderDTO>(order, HttpStatus.OK);
    }
